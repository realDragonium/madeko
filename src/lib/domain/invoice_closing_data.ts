...
export class SluitRecord {
	...
	public get EIString(): string {
		const entries = [
			new EIFlatFileRowSection('99',2),
			new EIFlatFileRowSection(this.quantity_patients_records,6),
			new EIFlatFileRowSection(this.quantity_debit_records,6),
			new EIFlatFileRowSection(this.quantity_prestation_records,6),
			new EIFlatFileRowSection(this.quantity_comment_records,6),
			new EIFlatFileRowSection(this.total_quantity_detail_records,7),
			new EIFlatFileRowSection(this.total_declaration_amount,11),
			new EIFlatFileRowSection(this.indicatie_debet_or_credit,1),
