...
export class Patient {
	...
	public static readString(textline: string): Patient {
		...
		textline.substring(27, 42);
		obj.id = textline.substring(42, 53);
	...
	public get EIString(): string {
		const entries = [
			...
			new EIFlatFileRowSection(this.name_inbetween_o1, 10),
			new EIFlatFileRowSection(this.name_code_o2, 1),
			new EIFlatFileRowSection(this.name_o2, 25),
			new EIFlatFileRowSection(this.name_inbetween_o2, 10),
